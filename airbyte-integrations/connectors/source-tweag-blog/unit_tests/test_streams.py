...
import pytest
from source_tweag_blog.source import TweagBlogStream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(TweagBlogStream, "path", "v0/example_endpoint")
    mocker.patch.object(TweagBlogStream, "primary_key", "test_primary_key")
    mocker.patch.object(TweagBlogStream, "__abstractmethods__", set())


def test_request_params(patch_base_class):
    stream = TweagBlogStream()
